...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val id  = intent?.getIntExtra("id",0) ?: throw IllegalStateException("O id não foi encontrado!")
        val url = "https://atway.tiagoaguiar.co/fenix/netflixapp/movie/$id?apiKey=034f17ec-8079-403c-b55a-5286bfd46b53"
    ...
    override fun onResult(movieDetail: MovieDetail) {
        ...
        txtCast.text = getString(string.cast, movieDetail.movie.cast)
        movies.clear()
